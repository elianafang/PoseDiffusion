...
from common.poseDiffusion_3dhp import *
...
model_pos_train = poseDiffusion(args, joints_left, joints_right, is_train=True)
model_pos_test_temp = poseDiffusion(args,joints_left, joints_right, is_train=False)
model_pos = poseDiffusion(args,joints_left, joints_right,  is_train=False, num_proposals=args.num_proposals, sampling_timesteps=args.sampling_timesteps)
